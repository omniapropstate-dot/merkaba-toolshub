...
function renderTool(id){
  ...
  switch(id){
    ...
    case 'control-seguimientos-excel': return toolSheetExterno('control-seguimientos-excel','&#128203;','Control de seguimientos','Registro de todos tus clientes y en qu&#233; etapa est&#225; cada uno.','https://docs.google.com/spreadsheets/d/1BmsbDxB5S3cKt_5hCi7kr6Bga8fXcaBr/edit?usp=sharing');
    ...
    case 'comparador-inmuebles-excel': return toolSheetExterno('comparador-inmuebles-excel','&#128200;','Comparador de inmuebles (plantilla)','Compara hasta 3 propiedades lado a lado &mdash; para mostrar al cliente y guiar la decisi&#243;n.','https://docs.google.com/spreadsheets/d/1M8aGTakJDSp9QIOTnDu5W07aDyLcN9kr/edit?usp=sharing');
    case 'calc-anticretico-excel': return toolSheetExterno('calc-anticretico-excel','&#128203;','Calculadora de anticr&#233;tico (plantilla)','C&#225;lculo completo: monto, IT, comisi&#243;n, gastos notariales &mdash; en USD y Bs.','https://docs.google.com/spreadsheets/d/1YA_9QK12_LLFBuyG8hFT7TCd1KL3lWil/edit?usp=sharing');
